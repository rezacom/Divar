...
export default function CenteredGrid() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl.url}${apiUrl.cityId}/buy-old-house`)
      .then(res => res.json())
      .then(res => {
  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={3} className={classes.marginTop}>
              ...
              <ul className="sidebox__nav sidebox__nav-child">
                ...
                <ul>
                  ...
                  <ul>
                    ...
                    <Link to="/buy-old-house" className="sidebox__nav-a-active">
                      <li>زمین و کلنگی</li>
                    </Link>
                  </ul>
                </ul>
        ...
        <Grid item xs={9}>
          <SearchMain catName={"زمین و کلنگی"} valueSearch={handleValueSearch} />
