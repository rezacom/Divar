...
export default function CenteredGrid() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl.url}${apiUrl.cityId}/buy-villa`)
      .then(res => res.json())
      .then(res => {
  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={3} className={classes.marginTop}>
              ...
              <ul className="sidebox__nav sidebox__nav-child">
                ...
                <ul>
                  <Link to="/buy-residential">
                    <li className="sidebox__nav" style={{ color: "#000000de" }}>
                      فروش مسکونی
                    </li>
                  </Link>
                  <ul>
                    <Link to="/buy-apartment">
                      <li>آپارتمان</li>
                    </Link>
                    <Link to="/buy-villa" className="sidebox__nav-a-active">
                      <li>خانه و ویلا </li>
                    </Link>
                    <Link to="/buy-old-house">
                      <li>زمین و کلنگی</li>
                    </Link>
                  </ul>
                </ul>
        ...
        <Grid item xs={9}>
          <SearchMain catName={"خانه و ویلا"} valueSearch={handleValueSearch} />
