...
export default function CenteredGrid() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl.url}${apiUrl.cityId}/buy-apartment`)
      .then(res => res.json())
      .then(res => {
  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={3} className={classes.marginTop}>
              ...
              <ul className="sidebox__nav sidebox__nav-child">
                ...
                <ul>
                  <Link to="/buy-residential">
                    <li className="sidebox__nav" style={{color: '#000000de'}}>فروش مسکونی</li>
                  </Link>
                  <ul>
                    <Link
                      to="/buy-apartment"
                      className="sidebox__nav-a-active"
                    >
                      <li>آپارتمان</li>
                    </Link>
                    <Link to="/buy-villa">
        ...
        <Grid item xs={9}>
          <SearchMain catName={"آپارتمان"} valueSearch={handleValueSearch} />
