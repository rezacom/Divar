...
export default function CenteredGrid() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl.url}${apiUrl.cityId}/rent-residential`)
      .then(res => res.json())
      .then(res => {
  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={3} className={classes.marginTop}>
              ...
              <ul className="sidebox__nav sidebox__nav-child">
                ...
                <ul>
                  <Link to="/rent-residential">
                    <li className="sidebox__nav-active">اجاره مسکونی </li>
                  </Link>
                  <ul>
                    <Link
                      to="/rent-apartment"
        ...
        <Grid item xs={9}>
          <SearchMain catName={"اجاره مسکونی"} valueSearch={handleValueSearch} />
