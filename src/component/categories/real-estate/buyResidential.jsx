...
export default function CenteredGrid() {
  ...
  useEffect(() => {
    ...
    fetch(`${apiUrl.url}${apiUrl.cityId}/buy-residential`)
      .then(res => res.json())
      .then(res => {
  ...
  return (
    <div className={classes.root}>
      <Grid container spacing={3} className={classes.marginTop}>
              ...
              <ul className="sidebox__nav sidebox__nav-child">
                ...
                <ul>
                  <Link to="/buy-residential">
                    <li className="sidebox__nav-active">فروش مسکونی</li>
                  </Link>
                  <ul>
                    <Link
                      to="/buy-apartment"
        ...
        <Grid item xs={9}>
          <SearchMain catName={"فروش مسکونی"} valueSearch={handleValueSearch} />
